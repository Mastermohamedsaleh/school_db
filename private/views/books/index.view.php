...
<?php $this->view('layouts/nav')?>
	...
	<div class="container-fluid p-4 shadow mx-auto" style="max-width: 1000px;">
		...
		<div class="card-group justify-content-center">
			...
			<td> 
			    <?php $ee = "book/edit/".$row['id']; ?>
			<a   href="book/edit/<?=$row['id']?>"   class="btn-sm btn btn-info text-white">Edit</a>

            <a href="book/delete/<?=$row['id']?>" class="btn-sm  btn btn-danger" >DELETE</a>
