...
<h2 class="text-success text-center">Delete Grade</h2>
...
<h4 class="text-center text-danger">Are uou Sure From  Delete <?php echo $row['grade']; ?></h4>
...
<?php else: ?>
      ...
      <h4 class="text-center text-danger">No Grade</h4>
